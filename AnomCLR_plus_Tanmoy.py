...
from modules.TransformerEncoder_standard import Transformer
from modules.ContrastiveLosses import clr_loss,anomclr_loss,anomclr_plus_loss,anomclr_plus_loss_bonus

from modules.my_jet_augs import rotate_jets, distort_jets, rescale_pts, crop_jets, translate_jets, collinear_fill_jets, collinear_fill_jets_fast , shift_pT ,pt_reweight_jet,drop_constits_jet_safe
...
base_dir = "/remote/gpu05/rueschkamp/outputs_from_queue/AnomCLR/plus/Tanmoy/" 
expt_tag = "Droppingsafe0.6" #args.expt
...
for epoch in range( args.n_epochs +1):
    ...
    for i, (data, labels) in enumerate(dl_training):
        ...
        x_k = drop_constits_jet_safe(x_k,0.3)
