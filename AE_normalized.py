...
# initialise logfile
logfile = open("/remote/gpu05/rueschkamp/outputs_from_queue/AnomCLR/AE/my_AE_normalize_logfile.txt", "a" )
...
expt_tag = "AE_RunDrop0.3allpos_normalized_lr1e5_specific" #Test_notdroppingall_normalized" #args.expt
...
dl_AE_testing_top = DataLoader(dataset_top, batch_size=batch_size, shuffle=False)
